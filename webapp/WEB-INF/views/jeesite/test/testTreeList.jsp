...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/test/testTree/">商品类型列表</a></li>
		<shiro:hasPermission name="test:testTree:edit"><li><a href="${ctx}/test/testTree/form">商品类型添加</a></li></shiro:hasPermission>
	</ul>
	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			...
			<shiro:hasPermission name="test:testTree:edit"><td>
				...
				<a href="${ctx}/test/testTree/delete?id={{row.id}}" onclick="return confirmx('确认要删除该商品类型及所有子类型吗？', this.href)">删除</a>
				<a href="${ctx}/test/testTree/form?parent.id={{row.id}}">添加下级商品类型</a> 

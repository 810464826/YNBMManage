...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/test/testTree/">商品类型列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="testTree" action="${ctx}/test/testTree/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">上级类型编号:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:hidden id="img" path="img" htmlEscape="false" maxlength="256" class="input-xlarge"/>
				<sys:ckfinder input="img" type="images" uploadPath="/commodityImg/commodityImg" selectMultiple="false"/>
			</div>
		</div>

...
<body>
	...
	<div class="footer">
		<p class="linklist">
			<a href="">一家一盒</a> <a href="">服务条款</a> <a href="">反馈建议</a>
		</p>
		<p class="copyright">© 1998 - 2014 yijiayihe Inc. All reserved.</p>
		<p class="linklist">
	...
	<script type="text/javascript">
		...
		function remainTime() {
			//alert(base);
			$.post(base + "pay/checkWeiXinPayOrder", {
				"orderNum" : $("input[name=orderNum]").val()
			}, function(data) {
				if (data != "true") {
					setTimeout("remainTime()", 1000);
				} else {
					location.href = base + "order/list";
				}
			});

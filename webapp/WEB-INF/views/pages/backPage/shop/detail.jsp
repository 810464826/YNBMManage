...
<html>
	...
	<div class="header">
		...
		<div id="shopCart" style="display:none; background-color: #fff;width:213px;height: 125px;position:absolute;left:1100px;border: 1px solid #707070;border-radius:6px;margin-top: -5px;">
			<div style="float:left;margin-left: 90px;margin-top: -40px;">
				<span style="padding: 1px 10px;border:1px;background-color: #ff702f;color:#fff;  border-radius: 10px;">1</span>
			</div>
			<div style="float: right;margin-top: 10px;margin-right: 10px">
				<img style="width: 12px" onclick="closeCart()" src="<%=basePath%>img_new/close_icon.png"/>
			</div>
			...
			<div class="photo">
				...
				<div class="show-picture">
					<div class="big-picture">
						<img src="<%=basePath%>img_new/picture_1.png"/>
					</div>
					<div class="list-picture">
						<div>
							<img class="active" src="<%=basePath%>img_new/picture_1.png"/>
						</div>
						<div>
							<img src="<%=basePath%>img_new/picture_1.png"/>
						</div>
						...
						<div>
							<img src="<%=basePath%>img_new/picture_1.png" style="margin-right: 0px"/>
						</div>
					</div>
				</div>
			...
			<div class="detail">
				<div class="introduce">
					<div class="title" style="margin-top: 40px;margin-bottom: 25px">
						<span>BREITSAMER (德国贝斯玛)进口蜂蜜</span>
					</div>
					<div class="line"></div>
					<div class="discount">
						<span>￥ 79.00</span>
					...
					<div class="price">
						<span style="color: #444444">市场价：</span><span style="text-decoration:line-through;color:#707070">￥ 108.00</span>
	...
	<script type="text/javascript">
		...
		setInterval(function(){
			var activeNode = $(".list-picture .active").parent().next();
			if(activeNode.length == 0){
				activeNode = $(".list-picture div:first");
			}
			activeNode.find("img").click();

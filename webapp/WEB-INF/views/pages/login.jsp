...
<%
	...
	if(user != null)
	{
		response.sendRedirect(basePath + "goods_main.jsp");
	}
%>
	   ...
	   <div style="float:right;">
        	<div style="float:right;width:36px;">
                <a href="javascript:closeWindow()">
                    <img src="<%=basePath%>/img_new/close_icon.png" alt="关闭" />
    	...
    	<div >
        	<div style="margin: 20px auto; text-align:center;">
                <a href="javascript:jump();">
                    <img style="margin-left:18px;" src="<%=basePath%>/img_new/LOGO_noText.png" alt="logo" />
                </a>
        ...
        <form id="main" style="margin-top: 20px;" action="<%=basePath%>user/login" method="post">
        	...
        	<div class="errTip" id="phone_title" style="opacity:1;">
        		<img alt="" src="<%=basePath%>img_new/information copy.png"> <span id="phone_title_txt">输入的手机号码不正确</span>
        	</div>
        	</c:if>
        	<c:if test="${exit_code != 1}">
        	...
        	<c:if test="${exit_code == 2}">
        	 <div class="errTip" id="pwd_title" style="opacity:1">
        		<img alt="" src="<%=basePath%>img_new/information copy.png"> <span id="pwd_title_txt">密码错误</span>
        	</div>
        	</c:if>
        	<c:if test="${exit_code != 2}">
            ...
            <div id="checkToggle">
            	<a href="<%=basePath%>pwd/find" target="_parent" style="color:#178FF2;font-size:12px;">找回密码</a>

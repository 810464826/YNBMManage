...
<body>
    <div id="content" style="height: 100%;">
        ...
        <form id="weixin_pay" action="<%=basePath%>pay/toWeixinPay" method="post">
        	...
        	<input name="subject" type="hidden" value="一家一盒注册会员"/>
        	<input name="totalFee" type="hidden" value="9.8"/>
        	<input name="body" type="hidden" value="一家一盒注册会员"/>
        ...
        <form id="alipayment" action="<%=basePath%>pages/buy/alipayapi.jsp" method="post" >
        	...
        	<input name="WIDsubject" type="hidden" value="一家一盒注册会员"/>
        	<input name="WIDtotal_fee" type="hidden" value="9.8"/>
        	<input name="WIDbody" type="hidden" value="一家一盒注册会员"/>

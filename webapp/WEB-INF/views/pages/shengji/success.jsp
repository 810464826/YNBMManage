...
<body>
    ...
    <div id="content" style="height: 100%;">
        ...
        <ul id="nav" style="color:#fff">
        	<li class="active"><img src="<%=basePath%>img_new/step1.png"/><span>选择会员类型</span></li>
        	<li class="active"><img src="<%=basePath%>img_new/step2.png"/><span>在线支付会费</span></li>
        	<li class="active"><img src="<%=basePath%>img_new/step3.png"/><span>升级成功</span></li>
        </ul>
    </div>
...
<SCRIPT TYPE="text/javascript">
    ...
    function waitting(){
        ...
        if(time == 1){
            clearInterval(timename);
            var base = document.getElementsByTagName("base")[0].getAttribute("href");
            window.location.href = base + "user/info";
        }
        $("#time").html(time - 1);
    }
    $(function(){

...
<html>
<head>
	<title><sitemesh:title default="欢迎光临"/> - ${fns:getConfig('productName')}</title>
      ...
      <div class="navbar-inner">
        <div class="container">
          <c:choose>
   			...
   			<c:otherwise><a class="brand" style="font-family: Microsoft YaHei;" href="${ctx}/index-${site.id}${fns:getUrlSuffix()}">${site.title}</a></c:otherwise>
   		  </c:choose>

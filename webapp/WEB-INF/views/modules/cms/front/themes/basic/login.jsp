	...
	<div id="content" >
	   <div style="float:right;">
        ...
        <form id="main" style="margin-top: 20px;" action="<%=basePath%>user/login" method="post">
            ...
            <div id="checkToggle">
            	<a href="${ctx}/pwd/find" target="_parent" style="color:#178FF2;font-size:12px;">找回密码</a>
            	<a href="${ctx}/register" target="_parent" style="color:#178FF2;font-size:12px;float: right">创建会员</a>
            </div>
        </form>
    </div>
</body>
